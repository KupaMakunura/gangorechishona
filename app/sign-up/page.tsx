...
const SignUp = () => {
  ...
  return (
    <div className="flex w-full justify-center ">
      <div className="md:w-[30%] max-md:w-full md:shadow flex-row px-8 md:mt-8 max-md:mt-3 md:py-8 rounded-md space-y-3">
        <div className="md:hidden">
          <span className="mt-4 px-3 text-2xl" onClick={() => router.back()}>
            <AiOutlineArrowLeft />
          </span>
        </div>
        ...
        <div>
          ...
          />
          <span className="text-xs ml-1 text-red-600 flex justify-start space-y-0">
            {FormikError.first_name}
          </span>
        </div>
        <div>
          <Input
