    ...
    <div className="flex w-full md:justify-center">
      <div className="md:flex  md:w-[70%] max-md:flex-row max-md:w-full max-md:px-3 md:shadow mt-8 rounded-md">
        <div className="flex-row w-full h-auto px-3 py-5">
          ...
          <p className="mt-3">
            Posted on <span className="font-semibold">12 Dec 2023</span>
          </p>
          ...
          <div className="w-full rounded-md border-slate-300  py-3 mt-3">
            <p>
              ...
              dhdhdhhdd dgdyd hdgy dhugffnfuf sifhgf fv fydfs sfdfdf hddhd
              dgdgudh dgdghdhd jdjdjdjdjdjdjdjdjdjdjd didiijv hdhuddh dgygdygydg
              dgdygdhd dddygd dhdhdhhdd dgdyd hdgy dhugffnfuf sifhgf fv fydfs
              sfdfdf hddhd dgdgudh dgdghdhd
            </p>
          </div>
        </div>
