...
const AppFooter = () => {
  ...
  return (
    <Footer
      id="contact-us"
      className="footer grid grid-flow-row-dense md:px-5 max-md:px-1 w-full py-5  "
    >
      <div className="grid md:grid-flow-col-dense max-md:grid-flow-row-dense w-full max-md:space-y-3  py-5 px-5">
        <div className="flex-1 space-y-3">
          <span className="logo-font text-3xl font-semibold ">
            Gango ReChishona
          </span>
          <div className="cursor-pointer">
            <span className="font-semibold">
              Location:{" "}
              <span className="font-thin">832 Sandon, Haydon Park, Harare</span>
            </span>
          </div>
          ...
          <div className="cursor-pointer">
            <span className="font-semibold">
              Email:{" "}
              <span className="font-thin">gangorechishona@gmail.com</span>
            </span>
          </div>
        </div>
          ...
          <ul className="space-y-3 cursor-pointer grid grid-flow-row-dense">
            {Links.map((link, index) => (
              <Link
                key={index}
                href={link.href}
                className="space-x-2 hover:font-semibold"
              >
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="grid grid-flow-row space-y-3 cursor-pointer">
        ...
        <div className="flex-1">
          ...
          <p className="mt-5">
            Receive latest news and updates from our company!!
          </p>
          <div className="md:flex max-md:flex-1 md:space-x-2 mt-7 max-md:space-y-3 ">
            <div className="flex-1 space-y-1">
              ...
              <span className="text-xs ml-1 text-red-600 flex justify-start"></span>
            </div>
                ...
                {data?.exists && (
                  <>
                    <AppAlert
                      ...
                      className="bg-error"
                      icon={
                        <AiOutlineCloseCircle className="inline-block mr-2 text-lg" />
                      }
                    >
